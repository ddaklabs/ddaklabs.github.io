...
앱은 사진 촬영을 위해 카메라 권한을, 사용자가 사진을 불러올 때 사진 보관함 권한을 요청합니다. 촬영 원본은 기본적으로 앱의 로컬 저장공간에만 보관됩니다. 사용자가 “NeverSame + 사진 앱”을 켜면 이후 직접 촬영한 새 원본을 기기 사진 앱의 NeverSame 전용 앨범에도 복사합니다. iOS에서는 이 앨범을 만들고 계속 사용하기 위해 사진 접근 권한이 필요하며, NeverSame은 이 옵션으로 기존 사진을 불러오거나 훑지 않습니다. 기존 기록이나 불러온 사진도 복사하지 않습니다. 사진은 기기에서 처리됩니다. 위치 권한은 선택 사항이며 새 사진의 장소와 선택적 날씨 정보를 만드는 데 사용됩니다. 주소 변환은 운영체제의 기본 지오코더에서 처리됩니다.
...
비개인화 배너 광고는 메인 프로젝트 화면 하단에 표시될 수 있습니다. 카메라, 사진 저장, 사진 상세 보기, 비교 및 변화 재생 화면에는 광고를 표시하지 않습니다. 초기 출시 버전은 전면 광고를 사용하지 않습니다.
